  ...
  <header>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container">
        ...
        <RouterLink class="navbar-brand ms-2 ms-sm-0" aria-current="page" to="/"><img src="@/assets/logo.png"
            alt="QuizApp" width="40" height="40"></RouterLink>

        <div class="offcanvas offcanvas-start" tabindex="-1" id="navbarOffcanvasLg"
          aria-labelledby="navbarOffcanvasLgLabel">
          <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Quizify</h5>
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <RouterLink class="nav-link" aria-current="page" to="/subscriptions">Subscriptions</RouterLink>
              </li>

              <li class="nav-item" v-if="isAuthenticated && user">
        ...
        <div class="dropdown ms-auto" v-if="isAuthenticated && user">
          <a href="#" data-bs-toggle="dropdown" aria-expanded="false"
            ...
            <img src="https://i.pravatar.cc/300" :alt="user.first_name" width="24" height="24"
              class="rounded-circle me-1"> {{ user.first_name }} {{ user.last_name }}
          </a>
